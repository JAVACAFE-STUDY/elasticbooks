...
public class Example20 {
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        ...
        String AGGREGATION_NAME_FOR_USER="tweetLang";
        String AGGREGATION_FIELD_FOR_USER = "tweetLang";

        String AGGREGATION_NAME_FOR_FOLLOWER = "userFollowersCount";
        String AGGREGATION_FIELD_FOR_FOLLOWER = "userFollowersCount";
